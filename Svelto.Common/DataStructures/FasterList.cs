...
namespace Svelto.DataStructures
{
    ...
    {
        public static FasterReadOnlyList<T> DefaultList = new FasterReadOnlyList<T>(FasterList<T>.DefaultEmptyList);
    ...
    {
        public static readonly FasterList<T> DefaultEmptyList = new FasterList<T>();
