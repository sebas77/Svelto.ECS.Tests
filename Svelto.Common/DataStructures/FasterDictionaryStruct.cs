...
{
    public struct FasterDictionaryStruct<TKey, TValue> : IFasterDictionary<TKey, TValue>, IDisposable
        where TKey : IEquatable<TKey>
    {
        public FasterDictionaryStruct(uint size):this()
        {
        ...
        {
            public FasterDictionaryKeyValueEnumerator(FasterDictionaryStruct<TKey, TValue> dic) : this()
            {
                _dic = dic;
                _index = -1;
            ...
            readonly FasterDictionaryStruct<TKey, TValue> _dic;
            readonly int                            _count;
