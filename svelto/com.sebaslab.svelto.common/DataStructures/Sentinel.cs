...
namespace Svelto.Common.DataStructures
{
    ...
    public static class SharedDictonary
    {
        ...
        static SharedDictonary()
        {
            ...
            {
#if UNITY_COLLECTIONS || UNITY_JOBS || UNITY_BURST                
                test = SharedStatic<SharedDictionaryStruct>.GetOrCreate<SharedDictionaryStruct, SharedDictonary>();
#endif            
                var test = default(SharedDictionaryStruct);

                test.test = MemoryUtilities
                   .Alloc<SveltoDictionary
                        <long, Sentinel, SentinelNativeStrategy<SveltoDictionaryNode<long>>,
                ...
                Unsafe.AsRef<SveltoDictionary<long, Sentinel, SentinelNativeStrategy<SveltoDictionaryNode<long>>,
                        SentinelNativeStrategy<Sentinel>, SentinelNativeStrategy<int>>>((void*)test.test)
                    =
...
#if UNITY_COLLECTIONS || UNITY_JOBS || UNITY_BURST
        public static readonly SharedStatic<SharedDictionaryStruct> test;
#else
